...
bunzip2 -c /var/local/moss/bulk-wikipedia/enwiki-latest-pages-articles-multistream.xml.bz2 | venv/bin/python3 xml_to_csv.py /var/local/moss/bulk-wikipedia/enwiki
